...
#ifndef POLYGONS__TRIANGLE_HPP_
#define POLYGONS__TRIANGLE_HPP_
...
/**
 * Regular polygon with three sides.
 */
class POLYGONS_PUBLIC Triangle : public PolygonBase::Polygon
{
...
protected:
  double POLYGONS_LOCAL compute_height();
  double side_length_;
};

}  // namespace Polygons

#endif  // POLYGONS__TRIANGLE_HPP_
